...
<!-- end content -->
<title>Psicomind - Listado de Pacientes</title>
...
<div id="primary">
  ...
  <div class="intro">Listado de Pacientes</div>
  ...
  <article class="page hentry">
    ...
    <div class="form-container">
      ...
      <form class="forms" action="listado_pacientes.php" method="post" enctype="multipart/form-data">
      	<p>Filtrar el listado de personas</p>
        <fieldset>
        <table class="table" width="100%">
			<tr class="tr">
            	<td class="td" width="27%">
					<input type="text" title="Código" name="codigo" id="codigo" value="{codigo}"
      ...
      <form class="forms" action="#" method="post" enctype="multipart/form-data">
        ...
        <table class="table" width="100%" id="tpersona">
        	<tr>
            	<th width="16%" style="text-align:center;"><b>Código</b></td>
                ...
                <th width="16%" style="text-align:center;"><b>Domicilio</b></td>
            ...
            <tr>
                ...
                <td width="16%" style="text-align:center;">{bloque_persona.domicilio}</td>
        		<td width="20%" style="text-align:center;">
                	<a href="ver_datos_paciente.php?id={bloque_persona.id_persona2}">
                    	<img alt="+" title="Ver datos completos" width="18px" height="18px" src="./style/images/mono-icons/pencil32.png">
                    </a>
                    <a href="desactivar_paciente.php?id={bloque_persona.id_persona2}">
