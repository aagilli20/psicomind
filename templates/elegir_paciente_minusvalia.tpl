...
<div id="primary">
  ...
  <div class="intro">Registrar la minusvalía de un paciente - Paso 1</div>
  ...
  <article class="page hentry">
    ...
    <div class="form-container">
      ...
      <form class="forms" action="elegir_paciente_minusvalia.php" method="post" enctype="multipart/form-data">
      	<p>Filtrar el listado de pacientes</p>
        <fieldset>
      ...
      <br>
      <form class="forms" action="paciente_minusvalia.php" method="post" enctype="multipart/form-data">
        ...
        <table class="table" width="100%" id="tpersona">
            ...
            <tr>
        		...
        		<td width="25%" style="text-align:center;">
                	<input type="radio" name="id_persona" id="{bloque_persona.id_persona}" value="{bloque_persona.id_persona}"
        ...
        <table class="table" width="100%">
          <tr class="tr">
            <td class="td" width="50%" style="text-align:center;">
             ...
             <td class="td" width="50%" style="text-align:center;">
              <input type="submit" value="Seleccionar" name="seleccionar" id="seleccionar" class="btn-submit" />
            </td>
          </tr>
        </table>
        </fieldset>
