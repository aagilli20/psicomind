...
<div id="primary">
  ...
  <div class="intro">Consignar turno - Último paso</div>
  ...
  <article class="page hentry">
    ...
    <div class="form-container">
      ...
      <form class="forms" action="guardar_turno.php" method="post" enctype="multipart/form-data">
        ...
        <fieldset>
        <table class="table" width="60%" id="tpersona">
        	<tr>
            	<th width="50%" style="text-align:center;"><b>Hora Inicio</b></td>
                <th width="50%" style="text-align:center;"><b>Seleccionar</b></td>
            </tr>
        	<tpl loop="bloque_turnos_disp">
            <tr>
                <td width="50%" style="text-align:center;"><span style="{bloque_turnos_disp.color}">{bloque_turnos_disp.hora_ini}</span></td>
        		<td width="50%" style="text-align:center;">
                	<input type="radio" name="hora_inicio" id="{bloque_turnos_disp.hora_ini}" value="{bloque_turnos_disp.hora_ini}"
                    {bloque_turnos_disp.disabled} >
                </td>
			</tr>
            </tpl loop="bloque_turnos_disp">
        </table>
        ...
        <table class="table" width="54%">
          <tr class="tr">
            ...
            <td class="td" width="33%" style="text-align:center;">
              <input type="button" value="Turno Extra" name="turno_extra" id="turno_extra" class="btn-submit"
              onClick="location.href='turno_extra.php?id1={id_paciente2}&id2={id_profesional2}&id3={dia_turno2}&id4={id_turno}'" />
            </td>
          </tr>
        </table>
        </fieldset>
