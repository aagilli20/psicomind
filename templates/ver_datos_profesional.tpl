...
<!-- end content -->
<title>Psicomind - Datos del Profesional</title>
...
<div id="primary">
  ...
  <div class="intro">Datos del Profesional</div>
  ...
  <article class="page hentry">
    ...
    <div class="form-container">
      ...
      <form class="forms" action="modificar_profesional.php" method="post" enctype="multipart/form-data">
        <fieldset>
        <table class="table" width="100%">
            ...
            <tr class="tr">
            	...
            	<td class="td" width="50%">
                    ...
                    id="matricula" readonly class="text-input defaultText required"/>*
                </td>
            </tr>
            <tr class="tr">
               	<td class="td" width="50%">
            ...
            <tr class="tr">
            	<td class="td" width="50%">
                	Teléfono Profesional (0342-45011XX):
                </td>
            	<td class="td" width="50%">
            ...
            <tr class="tr">
            	<td class="td" width="50%">
                	Celular Profesional (34245677XX):
                </td>
                <td class="td" width="50%">
        ...
        <table class="table" width="100%">
          <tr class="tr">
            ...
            <td class="td" width="12%">
              <input type="button" value="Volver" name="volver" id="volver" class="btn-submit" onClick="location.href='listado_profesionales.php'">
            </td>
            <td class="td" width="%38">
            	<span style="text-align:center;">Los campos marcados con * son obligatorios</span>
            </td>
          </tr>
        </table>
        </fieldset>
