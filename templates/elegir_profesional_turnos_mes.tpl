...
<!-- end content -->
<title>Psicomind - Turnos por Mes</title>
...
<div id="primary">
  ...
  <div class="intro">Turnos por Mes - Paso 1</div>
  ...
  <article class="page hentry">
    ...
    <div class="form-container">
      ...
      <form class="forms" action="elegir_profesional_turnos_mes.php" method="post" enctype="multipart/form-data"> 
      ...
      <br>
      <form class="forms" action="listado_turnos_por_mes.php" method="post" enctype="multipart/form-data">
        ...
        <table class="table" width="100%">
          <tr class="tr">
            <td class="td" width="34%">
              Ingrese el mes y el año
            </td>
             <td class="td" width="33%">
              <select name="select_mes" id="select_mes" class="select">
            ...
            <td class="td" width="33%">
              <select name="select_anio" id="select_anio" class="select">
              	<tpl loop="bloque_anio">
                 	<option value="{bloque_anio.id}">{bloque_anio.valor}</option>
                </tpl loop="bloque_anio">
              </select>*
            </td>
          </tr>
