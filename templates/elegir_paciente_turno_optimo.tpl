...
<div id="primary">
  ...
  <div class="intro">Asignar Turno Óptimo - Paso 1</div>
  ...
  <article class="page hentry">
    ...
    <div class="form-container">
      ...
      <form class="forms" action="elegir_paciente_turno_optimo.php" method="post" enctype="multipart/form-data">
      ...
      <br>
      <form class="forms" action="elegir_profesional_turno_optimo.php" method="post" enctype="multipart/form-data">
