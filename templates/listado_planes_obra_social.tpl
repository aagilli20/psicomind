...
<!-- end content -->
<title>Psicomind - Listado de Planes de la Obra Social</title>
...
<div id="primary">
  ...
  <div class="intro">Listado Planes de la Obra Social</div>
  ...
  <article class="page hentry">
    ...
    <div class="form-container">
      ...
      <form class="forms" action="#" method="post" enctype="multipart/form-data">
      	<p>Planes de {nombre_obra_social}</p>
        <fieldset>
        <table class="table" width="100%" id="tosocial">
        	<tr>
            	<th width="20%" style="text-align:center;"><b>Código</b></td>
            	<th width="30%" style="text-align:center;"><b>Plan</b></td>
            	<th width="30%" style="text-align:center;"><b>Cobertura</b></td>
                <th width="25%" style="text-align:center;"><b>Operaciones</b></td>
            </tr>
        	<tpl loop="bloque_plan_obra_social">
            <tr>
            	<td width="20%" style="text-align:center;">{bloque_plan_obra_social.id_plan}</td>
            	<td width="30%" style="text-align:center;">{bloque_plan_obra_social.plan}</td>
                <td width="30%" style="text-align:center;">{bloque_plan_obra_social.cobertura}</td>
        		<td width="20%" style="text-align:center;">
                	<a href="ver_datos_plan_obra_social.php?id={bloque_plan_obra_social.id_plan2}">
                    	<img alt="+" title="Ver datos completos" width="18px" height="18px" src="./style/images/mono-icons/pencil32.png">
                    </a>
                    <a href="eliminar_plan_obra_social.php?id={bloque_plan_obra_social.id_plan2}">
                    	<img alt="-" title="Eliminar el plan" width="18px" height="18px" src="./style/images/mono-icons/minus32.png">
                    </a>
                </td>
			</tr>
            </tpl loop="bloque_plan_obra_social">
        ...
        <table class="table" width="100%">
          <tr class="tr">
            <td class="td" width="100%" style="text-align:center;">
              ...
              onClick="location.href='listado_obras_sociales.php'">
            </td>
          </tr>
        </table>
        </fieldset>
