...
<!-- end content -->
<title>Psicomind - Listado de Turnos por Mes</title>
...
<div id="primary">
  ...
  <div class="intro">Listado de Turnos por Mes</div>
    ...
    <div class="form-container">
      ...
      <form class="forms" action="#" method="post" enctype="multipart/form-data">
        ...
        <table class="table" width="100%" id="thorario">
        	<tr>
            	<th width="15%" style="text-align:center;"><b>Horario</b></td>
                <th width="15%" style="text-align:center;"><b>Turno</b></td>
                <th width="15%" style="text-align:center;"><b>Fecha</b></td>
            	<th width="40%" style="text-align:center;"><b>Nombre y apellido</b></td>
                <th width="15%" style="text-align:center;"><b>Operaciones</b></td>
            </tr>
        	<tpl loop="bloque_turnos">
            <tr>
            	<td width="15%" style="text-align:center;">{bloque_turnos.horario}</td>
                <td width="15%" style="text-align:center;">{bloque_turnos.turno}</td>
                <td width="15%" style="text-align:center;">{bloque_turnos.dia}</td>
                <td width="40%" style="text-align:center;">{bloque_turnos.paciente}</td>
        		<td width="15%" style="text-align:center;">
                	<a href="eliminar_turno.php?id={bloque_turnos.id_turno_otorgado}" 
                    onclick="return confirm('¿Está seguro que desea eliminar el turno?')" >
                    	<img alt="-" title="Eliminar Turno" width="18px" height="18px" src="./style/images/mono-icons/minus32.png">
                    </a>
                </td>
			</tr>
            </tpl loop="bloque_turnos">
        ...
        <table class="table" width="100%">
          <tr class="tr">
            <td class="td" width="100%" style="text-align:center;">
              ...
              onClick="location.href='elegir_profesional_turnos_mes.php'">
            </td>
          </tr>
        </table>
        </fieldset>
