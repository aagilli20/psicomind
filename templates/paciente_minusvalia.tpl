...
<!-- end content -->
<title>Psicomind - Minusvalía del Paciente</title>
...
<div id="primary">
  ...
  <div class="intro">Registrar la minusvalía de un paciente - Paso 2</div>
  ...
  <article class="page hentry">
    ...
    <div class="form-container">
      ...
      <form class="forms" action="guardar_paciente_minusvalia.php" method="post" enctype="multipart/form-data">
        <fieldset>
        ...
        <table class="table" width="100%">
            ...
            <tr class="tr"><th>Seleccione la minusvalía</th><th></th></tr>
			<tpl loop="bloque_minusvalia">
            <tr class="tr">
            	<td class="td" width="50%">
                    <input type="checkbox" name="minusvalia[]" id="{bloque_minusvalia.id_minusvalia1}" 
                    value="{bloque_minusvalia.id_minusvalia1}" {bloque_minusvalia.chequeado1}>
                    {bloque_minusvalia.descripcion1}
                </td>
                <td class="td" width="50%">
                    <input type="checkbox" name="minusvalia[]" id="{bloque_minusvalia.id_minusvalia2}" 
                    value="{bloque_minusvalia.id_minusvalia2}" {bloque_minusvalia.chequeado2} {bloque_minusvalia.deshabilitado}>
	               	{bloque_minusvalia.descripcion2}
                </td>
            </tr>
            </tpl loop="bloque_minusvalia">
        </table>
