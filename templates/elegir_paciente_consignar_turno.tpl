...
<div id="primary">
  ...
  <div class="intro">Consignar turno - Paso 1</div>
  ...
  <article class="page hentry">
    ...
    <div class="form-container">
      ...
      <form class="forms" action="elegir_paciente_consignar_turno.php" method="post" enctype="multipart/form-data">
      ...
      <br>
      <form class="forms" action="elegir_profesional_consignar_turno.php" method="post" enctype="multipart/form-data">
