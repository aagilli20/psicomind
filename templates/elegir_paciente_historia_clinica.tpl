...
<div id="primary">
  ...
  <div class="intro">Historia Clínica - Paso 1</div>
  ...
  <article class="page hentry">
    ...
    <div class="form-container">
      ...
      <form class="forms" action="elegir_paciente_historia_clinica.php" method="post" enctype="multipart/form-data">
      ...
      <br>
      <form class="forms" action="historia_clinica.php" method="post" enctype="multipart/form-data">
