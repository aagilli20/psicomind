...
<!-- end content -->
<title>Psicomind - Nuevo Usuario</title>
...
<div id="primary">
  ...
  <div class="intro">Nuevo Usuario</div>
  ...
  <article class="page hentry">
    ...
    <div class="form-container">
      ...
      <form class="forms" action="nuevo_usuario.php" method="post" enctype="multipart/form-data">
      ...
      <br>
      <form class="forms" action="guardar_nuevo_usuario.php" method="post" enctype="multipart/form-data">
        ...
        <table class="table" width="100%">
          <tr class="tr">
            ...
            <td class="td" width="25%" style="text-align:left;">
