...
<!-- end content -->
<title>Psicomind - Reactivar Usuario</title>
...
<div id="primary">
  ...
  <div class="intro">Reactivar Usuario</div>
  ...
  <article class="page hentry">
    ...
    <div class="form-container">
      ...
      <form class="forms" action="reactivar_usuario.php" method="post" enctype="multipart/form-data">
      ...
      <br>
      <form class="forms" action="guardar_reactivar_usuario.php" method="post" enctype="multipart/form-data">
