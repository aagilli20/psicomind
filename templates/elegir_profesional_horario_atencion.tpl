...
<div id="primary">
  ...
  <div class="intro">Asociar horario de atención al profesional - Paso 1</div>
  ...
  <article class="page hentry">
    ...
    <div class="form-container">
      ...
      <form class="forms" action="elegir_profesional_horario_atencion.php" method="post" enctype="multipart/form-data">
