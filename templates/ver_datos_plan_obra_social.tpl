...
<!-- end content -->
<title>Psicomind - Modificar Plan</title>
...
<div id="primary">
  ...
  <div class="intro">Modificar Plan</div>
  ...
  <article class="page hentry">
    ...
    <div class="form-container">
      ...
      <form class="forms" action="modificar_plan_obra_social.php" method="post" enctype="multipart/form-data">
        <fieldset>
