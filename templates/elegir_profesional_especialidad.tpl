...
<div id="primary">
  ...
  <div class="intro">Asociar especialidad al profesional - Paso 1</div>
  ...
  <article class="page hentry">
    ...
    <div class="form-container">
      ...
      <form class="forms" action="elegir_profesional_especialidad.php" method="post" enctype="multipart/form-data">
      ...
      <br>
      <form class="forms" action="profesional_especialidad.php" method="post" enctype="multipart/form-data">
