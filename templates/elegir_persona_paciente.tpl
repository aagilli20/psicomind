...
<!-- end content -->
<title>Psicomind - Nuevo Paciente</title>
...
<div id="primary">
  ...
  <div class="intro">Nuevo Paciente</div>
  ...
  <article class="page hentry">
    ...
    <div class="form-container">
      ...
      <form class="forms" action="elegir_persona_paciente.php" method="post" enctype="multipart/form-data">
      ...
      <br>
      <form class="forms" action="guardar_nuevo_paciente.php" method="post" enctype="multipart/form-data">
