...
<!-- end content -->
<title>Psicomind - Modificar Obra Social</title>
...
<div id="primary">
  ...
  <div class="intro">Modificar Obra Social</div>
  ...
  <article class="page hentry">
    ...
    <div class="form-container">
      ...
      <form class="forms" action="modificar_obra_social.php" method="post" enctype="multipart/form-data">
        <fieldset>
