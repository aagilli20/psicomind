...
<div id="primary">
  ...
  <div class="intro">Consignar turno - Paso 2</div>
  ...
  <article class="page hentry">
    ...
    <div class="form-container">
      ...
      <br>
      <form class="forms" action="consignar_turno.php" method="post" enctype="multipart/form-data">
        ...
        <table class="table" width="100%">
          <tr class="tr">
            <td class="td" width="50%" style="text-align:center;">
              ...
              onClick="location.href='elegir_paciente_consignar_turno.php'">
            </td>
             <td class="td" width="50%" style="text-align:center;">
