...
<!-- end content -->
<title>Psicomind - Reactivar Paciente</title>
...
<div id="primary">
  ...
  <div class="intro">Reactivar Paciente</div>
  ...
  <article class="page hentry">
    ...
    <div class="form-container">
      ...
      <form class="forms" action="reactivar_paciente.php" method="post" enctype="multipart/form-data">
      ...
      <br>
      <form class="forms" action="guardar_reactivar_paciente.php" method="post" enctype="multipart/form-data">
        ...
        <table class="table" width="100%">
          <tr class="tr">
            <td class="td" width="50%" style="text-align:center;">
             ...
             <td class="td" width="50%" style="text-align:center;">
              <input type="submit" value="Reactivar" name="reactivar" id="reactivar" class="btn-submit" />
            </td>
          </tr>
        </table>
        </fieldset>
