...
<!-- end content -->
<title>Psicomind - Quitar profesional de un día no laboral</title>
...
<div id="primary">
  ...
  <div class="intro">Quitar profesional de un día no laboral</div>
  ...
  <article class="page hentry">
    ...
    <div class="form-container">
      ...
      <form class="forms" action="quitar_dia_no_laboral_profesional.php" method="post" enctype="multipart/form-data">
        ...
        <table class="table" width="100%">
          <tr class="tr">
            <td class="td" width="30%" style="text-align:center;">
             ...
             <td class="td" width="30%" style="text-align:center;">
              <input type="submit" value="Quitar" name="guardar" id="guardar" class="btn-submit" />
            </td>
            <td class="td" width="40%" style="text-align:center;">
              <input type="button" value="Quitar Todos" name="guardar_todos" id="guardar_todos" class="btn-submit" 
              onClick="location.href='quitar_dia_no_laboral_todo_profesional.php?id={id_dia_no_laboral}'">
            </td>
          </tr>
        </table>
        <br>
