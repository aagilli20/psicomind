...
<!-- end content -->
<title>Psicomind - Listado de Profesionales</title>
...
<div id="primary">
  ...
  <div class="intro">Listado de Profesionales</div>
  ...
  <article class="page hentry">
    ...
    <div class="form-container">
      ...
      <form class="forms" action="listado_profesionales.php" method="post" enctype="multipart/form-data">
      	<p>Filtrar el listado de profesionales</p>
        <fieldset>
        <table class="table" width="100%">
			<tr class="tr">
            	<td class="td" width="27%">
					<input type="text" title="Número de Matrícula" name="matricula" id="matricula" value="{matricula}"
      ...
      <form class="forms" action="#" method="post" enctype="multipart/form-data">
        ...
        <table class="table" width="100%" id="tpersona">
        	<tr>
            	<th width="16%" style="text-align:center;"><b>Matrícula</b></td>
            	<th width="16%" style="text-align:center;"><b>Documento</b></td>
            	<th width="16%" style="text-align:center;"><b>Apellido</b></td>
                <th width="16%" style="text-align:center;"><b>Nombres</b></td>
                <th width="16%" style="text-align:center;"><b>Domicilio Profesional</b></td>
                <th width="20%" style="text-align:center;"><b>Operaciones</b></td>
            </tr>
        	<tpl loop="bloque_persona">
            <tr>
            	<td width="16%" style="text-align:center;">{bloque_persona.id_persona}</td>
            	<td width="16%" style="text-align:center;">{bloque_persona.documento}</td>
                <td width="16%" style="text-align:center;">{bloque_persona.apellido}</td>
                <td width="16%" style="text-align:center;">{bloque_persona.nombre}</td>
                <td width="16%" style="text-align:center;">{bloque_persona.domicilio_prof}</td>
        		<td width="20%" style="text-align:center;">
                	<a href="ver_datos_profesional.php?id={bloque_persona.id_persona2}">
                    	<img alt="+" title="Ver datos completos" width="18px" height="18px" src="./style/images/mono-icons/pencil32.png">
                    </a>
                    <a href="desactivar_profesional.php?id={bloque_persona.id_persona2}">
                    	<img alt="-" title="Registrar baja" width="18px" height="18px" src="./style/images/mono-icons/minus32.png">
                    </a>
                </td>
			</tr>
            </tpl loop="bloque_persona">
