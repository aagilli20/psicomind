...
<!-- end content -->
<title>Psicomind - Listado de Usuarios</title>
...
<div id="primary">
  ...
  <div class="intro">Listado de Usuarios</div>
  ...
  <article class="page hentry">
    ...
    <div class="form-container">
      ...
      <form class="forms" action="listado_usuarios.php" method="post" enctype="multipart/form-data">
      	<p>Filtrar el listado de usuarios</p>
        <fieldset>
        <table class="table" width="100%">
			<tr class="tr">
            	<td class="td" width="27%">
					<input type="text" title="Nombre de Usuario" name="nick" id="nick" value="{nick}"
      ...
      <form class="forms" action="#" method="post" enctype="multipart/form-data">
        ...
        <table class="table" width="100%" id="tpersona">
        	<tr>
            	<th width="20%" style="text-align:center;"><b>Nombre de Usuario</b></td>
            	<th width="20%" style="text-align:center;"><b>Documento</b></td>
            	<th width="20%" style="text-align:center;"><b>Apellido</b></td>
                <th width="20%" style="text-align:center;"><b>Nombres</b></td>
                <th width="20%" style="text-align:center;"><b>Operaciones</b></td>
            </tr>
        	<tpl loop="bloque_persona">
            <tr>
            	<td width="20%" style="text-align:center;">{bloque_persona.id_persona}</td>
            	<td width="20%" style="text-align:center;">{bloque_persona.documento}</td>
                <td width="20%" style="text-align:center;">{bloque_persona.apellido}</td>
                <td width="20%" style="text-align:center;">{bloque_persona.nombre}</td>
        		<td width="20%" style="text-align:center;">
                	<a href="ver_datos_usuario.php?id={bloque_persona.id_persona2}">
                    	<img alt="+" title="Ver datos completos" width="18px" height="18px" src="./style/images/mono-icons/pencil32.png">
                    </a>
                    <a href="desactivar_usuario.php?id={bloque_persona.id_persona2}">
