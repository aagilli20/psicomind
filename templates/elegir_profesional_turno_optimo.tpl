...
<div id="primary">
  ...
  <div class="intro">Asignar Turno Óptimo - Paso 2</div>
  ...
  <article class="page hentry">
    ...
    <div class="form-container">
      ...
      <br>
      <form class="forms" action="buscar_turno_optimo.php" method="post" enctype="multipart/form-data">
        ...
        <table class="table" width="100%">
          <tr class="tr">
            <td class="td" width="30%" style="text-align:center;">
              ...
              onClick="location.href='elegir_paciente_turno_optimo.php'">
            </td>
             <td class="td" width="30%" style="text-align:center;">
            ...
            <td class="td" width="40%" style="text-align:center;">
            	Turno doble&nbsp;<input type="checkbox" name="doble" id="doble" />
            </td>
          </tr>
        </table>
