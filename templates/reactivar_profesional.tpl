...
<!-- end content -->
<title>Psicomind - Reactivar Profesional</title>
...
<div id="primary">
  ...
  <div class="intro">Reactivar Profesional</div>
  ...
  <article class="page hentry">
    ...
    <div class="form-container">
      ...
      <form class="forms" action="reactivar_profesional.php" method="post" enctype="multipart/form-data">
      ...
      <br>
      <form class="forms" action="guardar_reactivar_profesional.php" method="post" enctype="multipart/form-data">
