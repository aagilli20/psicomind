...
<div id="primary">
  ...
  <div class="intro">Nuevo Profesional - Paso 1</div>
  ...
  <article class="page hentry">
    ...
    <div class="form-container">
      ...
      <form class="forms" action="elegir_persona_profesional.php" method="post" enctype="multipart/form-data">
      ...
      <br>
      <form class="forms" action="nuevo_profesional.php" method="post" enctype="multipart/form-data">
        ...
        <table class="table" width="100%" id="tpersona">
            ...
            <tr>
        		...
        		<td width="25%" style="text-align:center;">
                	<input type="radio" name="persona" id="{bloque_persona.id_persona}" value="{bloque_persona.id_persona}"
