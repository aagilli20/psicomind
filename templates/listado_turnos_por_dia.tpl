...
<!-- end content -->
<title>Psicomind - Listado de Turnos por Día</title>
...
<div id="primary">
  ...
  <div class="intro">Listado de Turnos por Día</div>
    ...
    <div class="form-container">
      ...
      <form class="forms" action="#" method="post" enctype="multipart/form-data">
        ...
        <table class="table" width="100%" id="thorario">
        	<tr>
            	<th width="20%" style="text-align:center;"><b>Horario</b></td>
            ...
            <tr>
            	<td width="20%" style="text-align:center;">{bloque_turnos.horario}</td>
                <td width="20%" style="text-align:center;">{bloque_turnos.turno}</td>
        ...
        <table class="table" width="100%">
          <tr class="tr">
            <td class="td" width="100%" style="text-align:center;">
              ...
              onClick="location.href='elegir_profesional_turnos.php'">
            </td>
          </tr>
        </table>
        </fieldset>
