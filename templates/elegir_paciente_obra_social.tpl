...
<div id="primary">
  ...
  <div class="intro">Asociar Obra Social - Paso 1</div>
  ...
  <article class="page hentry">
    ...
    <div class="form-container">
      ...
      <form class="forms" action="elegir_paciente_obra_social.php" method="post" enctype="multipart/form-data">
      ...
      <br>
      <form class="forms" action="asociar_obra_social.php" method="post" enctype="multipart/form-data">
