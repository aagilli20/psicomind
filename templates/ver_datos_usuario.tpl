...
<!-- end content -->
<title>Psicomind - Datos del Usuario</title>
...
<div id="primary">
  ...
  <div class="intro">Datos del Usuario</div>
      ...
      <form class="forms" action="#" method="post" enctype="multipart/form-data">
        ...
        <table class="table" width="100%">
            ...
            <tr class="tr">
            	...
            	<td class="td" width="50%">
                    ...
                    id="nick" readonly class="text-input defaultText required"/>
                </td>
            </tr>
            <tr class="tr">
               	<td class="td" width="50%">
        ...
        <table class="table" width="100%">
          <tr class="tr">
            ...
            <td class="td" width="33" style="text-align:center;">
              <input type="button" value="Volver" name="volver" id="volver" class="btn-submit" onClick="location.href='listado_usuarios.php'">
            </td>
          </tr>
        </table>
        </fieldset>
