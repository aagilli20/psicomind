...
--
-- Servidor: localhost
-- Tiempo de generación: 10-03-2014 a las 18:20:50
...
CREATE TABLE IF NOT EXISTS `obra_social` (
  `id_obra_social` smallint(6) NOT NULL AUTO_INCREMENT,
  `rnemp` varchar(8) DEFAULT NULL,
...
INSERT INTO `obra_social` (`id_obra_social`, `rnemp`, `nombre`, `telefono`, `direccion`, `localidad`, `provincia`, `cp`) VALUES
(1, '', 'IAPOS', '', 'San Martín 3145', 'Santa Fe', 'Santa Fe', 'S3000FSO');
...
--
-- Estructura de tabla para la tabla `plan_obra_social`
--

CREATE TABLE IF NOT EXISTS `plan_obra_social` (
  `id_plan` int(11) NOT NULL AUTO_INCREMENT,
  `plan` varchar(100) NOT NULL,
  `cobertura` varchar(200) DEFAULT NULL,
...
--
-- Filtros para la tabla `plan_obra_social`
--
ALTER TABLE `plan_obra_social`
  ADD CONSTRAINT `plan_obra_social_ibfk_1` FOREIGN KEY (`id_obra_social`) REFERENCES `obra_social` (`id_obra_social`) ON DELETE CASCADE ON UPDATE CASCADE;
